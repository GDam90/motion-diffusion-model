...
def add_base_options(parser):
    ...
    group.add_argument("--condition", default="", type=str, help="The form of conditioning ('' for text, act and unconstrained, 'motion')")
...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='humanml', choices=['humanml', 'kit', 'humanact12', 'uestc', 'h36m'], type=str, # ADDED HUMAN
...
def add_training_options(parser):
    ...
    group.add_argument("--train_platform_type", default='NoPlatform', choices=['NoPlatform', 'ClearmlPlatform', 'TensorboardPlatform', 'WandbPlatform'], type=str, # WandBPlatform
